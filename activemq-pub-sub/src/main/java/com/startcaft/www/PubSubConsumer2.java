    ...
    public static void main(String[] args) {
        {
            ...
            System.out.println("默认ActiveMQ连接用户名:" + PubSubConsumer2.USERNAME);
            System.out.println("默认ActiveMQ连接密码:" + PubSubConsumer2.PASSWORD);
            System.out.println("默认ActiveMQ连接地址:" + PubSubConsumer2.BROKEURL);

            try {
                //实例化连接工厂对象
                factory = new ActiveMQConnectionFactory(PubSubConsumer2.USERNAME, PubSubConsumer2.PASSWORD, PubSubConsumer2.BROKEURL);
                //通过连接工厂获取到连接对象，并启动
